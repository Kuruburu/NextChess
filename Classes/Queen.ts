...
class Queen extends ChessPiece{
  ...
  // Get available moves for the Queen
  getAvailableMoves(board: { [key: string]: ChessPiece}): string[] {
    const files = ["a", "b", "c", "d", "e", "f", "g", "h"];
    const directions = [
      { fileChange: 1, rankChange: 1 },   // Up-right (diagonal)
      { fileChange: 1, rankChange: -1 },  // Down-right (diagonal)
      { fileChange: -1, rankChange: 1 },  // Up-left (diagonal)
      { fileChange: -1, rankChange: -1 }, // Down-left (diagonal)
      { fileChange: 1, rankChange: 0 },   // Right (horizontal)
      { fileChange: -1, rankChange: 0 },  // Left (horizontal)
      { fileChange: 0, rankChange: 1 },   // Up (vertical)
      { fileChange: 0, rankChange: -1 },  // Down (vertical)
    ];
